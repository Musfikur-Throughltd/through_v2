                ...
                {dataArr.map((data, idx) => (
                    ...
                    >
                        ...
                        <div className="text-center">
                            ...
                            <div
                                className={`grid overflow-hidden text-slate-600 transition-all shadow-xl duration-500 ease-in-out ${activeIndex >= idx && !hideAllAccordions ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"
                                    }`}
                            >
