  ...
  return (
    <nav className="flex items-center justify-between px-4 py-2 max-w-screen-xl mx-auto">
      ...
      >
        ...
        {/* Sidebar Drawer */}
        <div
          className={`fixed top-0 right-0 h-full backdrop-blur-3xl z-50 w-full transform transition-transform duration-500 ease-in-out ${
        ...
        >
          ...
          <div className="flex justify-between p-4">
            ...
            <button
              ...
              className="text-[#28519A] text-2xl"
            >
              &times;
            </button>
          </div>
          ...
          <ul className="flex flex-col justify-center items-center text-xl gap-6 mt-2 text-black">
            ...
            <li className="cursor-pointer py-2  hover:text-[#28519A] font-semibold">
              Home
            </li>
            <li className="cursor-pointer py-2  hover:text-[#28519A] font-semibold">
              <a href="#aboutUs">About Us</a>
